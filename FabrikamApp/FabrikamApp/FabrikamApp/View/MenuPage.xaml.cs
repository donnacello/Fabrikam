...
namespace FabrikamApp.View
{
    public partial class MenuPage : ContentPage
    {
        ...
        private async Task ShowNF(string s)
        {
            try
            {
                using (HttpClient client = new HttpClient())
                {
                    ...
                    await Application.Current.MainPage.DisplayAlert("Nutrition Facts",
                        s + ": " + Environment.NewLine
                        + "   " + calories + Environment.NewLine
                        + "   " + cholesterol + Environment.NewLine
                        + "   " + sodium, "Ok");
                    //and then deselect the item.
                }
            ...
            catch (Exception ex)
            {
                await Application.Current.MainPage.DisplayAlert("Oops..",
                    "Could not retrieve data. Please ensure you are connected to the web","Ok");
            }
        }
    }
}
